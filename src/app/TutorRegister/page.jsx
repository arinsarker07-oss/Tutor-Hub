...
export default function TutorRegisterSection() {
  ...
  const handleTutorSignUp = async (e) => {
    ...
    // ফর্ম থেকে সব ডাটা নেওয়া
    const form = e.target;
    const formData = new FormData(form);

    // ডাটাগুলোকে একটি অবজেক্টে রূপান্তর করা
    const tutorData = {
    ...
    try {
      // ব্যাকএন্ডে POST রিকোয়েস্ট পাঠানো
  ...
  return (
    <section className="w-full max-w-4xl mx-auto px-4 my-16 relative">
      ...
      <div className="bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800/80 rounded-3xl p-6 md:p-10 shadow-sm">
        <form onSubmit={handleTutorSignUp} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col space-y-2">
              <label className="text-xs font-bold text-zinc-500 dark:text-zinc-400">Session End Date</label>
              <div className="relative flex items-center">
                <FaCalendarAlt className="absolute left-4 text-zinc-400 text-sm" />
                <input
                  type="date"
